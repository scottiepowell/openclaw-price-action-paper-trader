...
This repo is in **Phase 6 — Alpaca paper adapter scaffold**.
...
Phase 5 added an offline-only execution journal and reconciliation reporting layer.
Phase 6 adds a disabled-by-default Alpaca paper broker scaffold.
